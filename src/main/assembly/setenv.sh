...
if [ -n "$BITS" ]; then
    JAVA_MEM_OPTS=" -server -Xmx8g -Xms8g -Xmn256m -XX:MetaspaceSize=128m -XX:MaxMetaspaceSize=256m -Xss256k -XX:+DisableExplicitGC -XX:+UseConcMarkSweepGC -XX:+CMSParallelRemarkEnabled -XX:+UseCMSCompactAtFullCollection -XX:LargePageSizeInBytes=128m -XX:+UseFastAccessorMethods -XX:+UseCMSInitiatingOccupancyOnly -XX:CMSInitiatingOccupancyFraction=70 "
else
    JAVA_MEM_OPTS=" -server -Xms8g -Xmx8g -XX:MaxMetaspaceSize=256m -XX:SurvivorRatio=2 -XX:+UseParallelGC "
fi
